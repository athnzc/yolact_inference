...
arpagi_dataset = dataset_base.copy({
  'name': 'Arpagi_Dataset',
  'train_images':'/mnt/266A47CE6A479A07/detectron2_files/datasets/resampled_arpagi_220_plus_4/train',
'train_info':'/mnt/266A47CE6A479A07/detectron2_files/datasets/resampled_arpagi_220_plus_4/train/via_region_data_coco5.json',
'valid_images':'/mnt/266A47CE6A479A07/detectron2_files/datasets/resampled_arpagi_220_plus_4/val',
'valid_info':'/mnt/266A47CE6A479A07/detectron2_files/datasets/resampled_arpagi_220_plus_4/val/via_region_data_coco5.json',
...
anodos=dataset_base.copy({
    'name': 'Anodos',
    'train_images':'/mnt/266A47CE6A479A07/athena/yolo/data/train_expand/resized_1280_720',
    'train_info':'/mnt/266A47CE6A479A07/athena/yolo/data/train_expand/resized_1280_720/resized_COCO_fixed.json',
    'valid_images':'/mnt/266A47CE6A479A07/athena/yolo/data/val_expand/resized_1280_720',
    'valid_info':'/mnt/266A47CE6A479A07/athena/yolo/data/val_expand/resized_1280_720/resized_COCO_fixed.json',

    'class_names': ('base', 'anode',),
    'label_map':{ 1:  1 , 2: 2},
...
yolact_resnet101_fpn_arpagi_config = yolact_base_config.copy({  # this specify which model to train
    'name': 'yolact_resnet101_fpn_arpagi',
    # Dataset stuff
    'dataset': arpagi_dataset,   # this is the name of your dataset specified at code above 
    'num_classes': len(arpagi_dataset.class_names) + 1,
    'max_iter': 1000,
    'lr_steps': (280, 460),
...
yolact_resnet50_fpn_arpagi_config=yolact_resnet50_config.copy({  # this specify which model to train
    'name': 'yolact_resnet50_fpn_arpagi',
    # Dataset stuff
    'dataset': arpagi_dataset,   # this is the name of your dataset specified at code above
    'num_classes': len(arpagi_dataset.class_names) + 1,
    'max_iter': 5640,
...
# 60 epoxew me arixko 0.001 kai meta apo 20 epoxes 0.0001
yolact_resnet50_fpn_arpagi_config_test1=yolact_resnet50_fpn_arpagi_config.copy({
    'lr': (1e-4),
    'max_iter': 11280,
    'lr_steps': (3760,),
...
yolact_resnet50_fpn_arpagi_config_test2=yolact_resnet50_fpn_arpagi_config_test1.copy({
    'lr': 1e-4,
    'lr_steps': (3760,7520,),
...
yolact_resnet50_fpn_arpagi_config_test3=yolact_resnet50_fpn_arpagi_config_test2.copy({
    'lr': (1e-4),
    'max_iter': 18800,
    'lr_steps': (5640,11280),
})

anodos_resnet50_config=yolact_resnet50_config.copy({
    'name': 'yolact_resnet50_fpn_anodos',
    'num_classes': 3,
    'dataset': anodos,
    'lr': (1e-4),
    #'lr_warmup_init': (1e-4),
    ...
    'augment_random_sample_crop': True,
    'lr_warmup_until': 0,
    #'lr_steps': (650, 850, 1000),



})

anodos_resnet101_config=yolact_base_config.copy({
    'name': 'yolact_resnet101_fpn_anodos',
    'num_classes': 3,
    'dataset': anodos,
    'lr': (1e-4),
    #'lr_warmup_init': (1e-4),
...
anodos_resnet50_config_2023_06_22_150650=anodos_resnet50_config.copy({
    "lr": 1e-10,
    "max_iter": 100
})
anodos_resnet50_config_2023_06_22_150928=anodos_resnet50_config.copy({
    "lr": 1e-10,
    "max_iter": 100
})
anodos_resnet50_config_2023_06_22_151404=anodos_resnet50_config.copy({
    "lr": 1e-10,
    "max_iter": 100
})
anodos_resnet50_config_2023_06_22_151553=anodos_resnet50_config.copy({
    "lr": 1e-10,
    "max_iter": 100
})
anodos_resnet50_config_2023_06_22_151654=anodos_resnet50_config.copy({
    "lr": 1e-10,
    "max_iter": 100
})
anodos_resnet50_config_2023_06_22_151806=anodos_resnet50_config.copy({
    "lr": 1e-10,
    "max_iter": 100
})
anodos_resnet50_config_2023_06_22_151853=anodos_resnet50_config.copy({
    "lr": 1e-06,
    "max_iter": 50
})
anodos_resnet50_config_2023_06_22_155310=anodos_resnet50_config.copy({
    "lr": 1e-10,
    "max_iter": 100
})
anodos_resnet50_config_2023_06_22_155409=anodos_resnet50_config.copy({
    "lr": 1e-06,
    "max_iter": 50
})
anodos_resnet50_config_2023_06_22_155714=anodos_resnet50_config.copy({
    "lr": 1e-10,
    "max_iter": 100
})
anodos_resnet50_config_2023_06_22_155747=anodos_resnet50_config.copy({
    "lr": 1e-06,
    "max_iter": 50
})
anodos_resnet50_config_2023_06_22_160342=anodos_resnet50_config.copy({
    "lr": 1e-10,
    "max_iter": 100
})
anodos_resnet50_config_2023_06_22_160416=anodos_resnet50_config.copy({
    "lr": 1e-06,
    "max_iter": 50
})

anodos_resnet50_config2=anodos_resnet50_config.copy({
    "lr": 1e-06,
    "max_iter": 50
})
anodos_resnet50_config_2023_06_23_133847=anodos_resnet50_config.copy({
    "lr": 0.0001,
    "max_iter": 6000
})
anodos_resnet50_config_2023_06_23_175359=anodos_resnet50_config.copy({
    "lr": 1e-05,
    "max_iter": 8000
})
anodos_resnet50_config_2023_06_23_184352=anodos_resnet50_config.copy({
    "lr": 1e-05,
    "max_iter": 8000
})
anodos_resnet50_config_2023_06_23_200357=anodos_resnet50_config.copy({
    "lr": 0.0001,
    "max_iter": 10000,
    "lr_steps": [
        6000,
...
anodos_resnet50_config_2023_06_27_125226=anodos_resnet50_config.copy({
    "lr": 0.0001,
    "max_iter": 100,
    "lr_steps": [
        6000,
...
anodos_resnet50_config_2023_06_27_125837=anodos_resnet50_config.copy({
    "lr": 0.0001,
    "max_iter": 100,
    "lr_steps": [
        6000,
...
anodos_resnet50_config_2023_06_27_125959=anodos_resnet50_config.copy({
    "lr": 0.0001,
    "max_iter": 100,
    "lr_steps": [
        6000,
...
anodos_resnet50_config_2023_06_27_130021=anodos_resnet50_config.copy({
    "lr": 0.0001,
    "max_iter": 100,
    "lr_steps": [
        6000,
...
anodos_resnet50_config_2023_06_27_130226=anodos_resnet50_config.copy({
    "lr": 0.0001,
    "max_iter": 10000,
    "lr_steps": [
        6000,
...
anodos_resnet50_config_2023_06_27_143318=anodos_resnet50_config.copy({
    "lr": 0.0001,
    "max_iter": 10000,
    "lr_steps": [
        6000,
...
anodos_resnet101_config_2023_06_29_210430=anodos_resnet101_config.copy({
    "lr": 0.0001,
    "max_iter": 10000,
    "lr_steps": [
        6000,
...
anodos_resnet101_config_2023_06_29_210618=anodos_resnet101_config.copy({
    "lr": 0.0001,
    "max_iter": 10000,
    "lr_steps": [
        6000,
...
anodos_resnet101_config_2023_06_29_210653=anodos_resnet101_config.copy({
    "lr": 0.0001,
    "max_iter": 10000,
    "lr_steps": [
        6000,
...
anodos_eval_set = coco2017_testdev_dataset.copy({
    'name': 'anodos_eval_set',

    'valid_images': '/mnt/266A47CE6A479A07/athena/yolo/data/extracted_frames_sc03_ch01/resized_1280_720',
    'valid_info': '/mnt/266A47CE6A479A07/athena/yolo/data/extracted_frames_sc03_ch01/resized_1280_720/sc03_ch01_coco.json',
    'has_gt': False,
...
anodos_eval_set2 = anodos_eval_set.copy({
    'name': 'anodos_eval_set2',

    'valid_images': '/mnt/266A47CE6A479A07/athena/yolo/data/extracted_frames_sc03_ch01/resized_1280_720/test',
    'valid_info': '/mnt/266A47CE6A479A07/athena/yolo/data/extracted_frames_sc03_ch01/resized_1280_720/test/test_coco.json',
})

anodos_sc03_ch01 = anodos_eval_set.copy({
    'name': 'anodos_eval_set',
...
anodos_sc03_ch03 = anodos_eval_set.copy({    
    'name': 'anodos_sc03_ch03',

    'valid_images': '/mnt/266A47CE6A479A07/athena/yolo/data/extracted_frames_sc03_ch03/resized_1280_720/',
    'valid_info': '/mnt/266A47CE6A479A07/athena/yolo/data/extracted_frames_sc03_ch03/resized_1280_720/sc03_ch03_coco.json',})

anodos_sc04_ch01 = anodos_eval_set.copy({
    'name': 'anodos_sc04_ch01',

    'valid_images': '/mnt/266A47CE6A479A07/athena/yolo/data/extracted_frames_sc04_ch01/resized_1280_720/',
    'valid_info': '/mnt/266A47CE6A479A07/athena/yolo/data/extracted_frames_sc04_ch01/resized_1280_720/sc04_ch01_coco.json',
})


anodos_sc04_ch03 = anodos_eval_set.copy({
    'name': 'anodos_sc04_ch03',

    'valid_images': '/mnt/266A47CE6A479A07/athena/yolo/data/extracted_frames_sc04_ch03/resized_1280_720/',
    'valid_info': '/mnt/266A47CE6A479A07/athena/yolo/data/extracted_frames_sc04_ch03/resized_1280_720/sc04_ch03_coco.json',
})