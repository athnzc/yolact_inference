...
class Detections:
    ...
    def add_mask(self, image_id:int, category_id:int, segmentation:np.ndarray, score:float):
        ...
        #print('!!!!!!!!!!!!!!!!! RLE')
        #rle = segmentation.astype(np.uint8)
        #rle = rle.tolist()
        #pprint.pprint(rle)

        #print('@@@@@@@@ SEGMENTATION')
        #pprint.pprint(segmentation.astype(np.uint8))
    ...
    def dump(self):
        ...
        for data, path in dump_arguments:
            with open(path, 'w') as f:
                f.write(json.dumps(data, indent=4)) #TODO: My fix
...
def evalimages(net:Yolact, input_folder:str, output_folder:str):
    ...
    print()
    print('******number of test images in ',input_folder , len(glob.glob(input_folder+"/*.png")))
